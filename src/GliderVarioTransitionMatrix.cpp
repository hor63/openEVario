    ...
    GliderVarioStatus const &lastStatus)
{
  ...
  FloatType timeSquareHalf2Lon = timeSquareHalf / lenLongitude;
  ...
  FloatType timeSquareHalf2Lat = timeSquareHalf / lenLatitude;
  ...
  transitionMatrix(GliderVarioStatus::STATUS_IND_VERTICAL_SPEED,GliderVarioStatus::STATUS_IND_GRAVITY) = timeDiff;
